  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="card m-auto mt-4" style="width:700px;">
            ...
            <div class="card-body">
                <!-- <h6 class="text-danger" style="font-size: 12px;"> * Pastikan data tidak terduplikat!</h6> -->
                ...
                <div class="mb-3 row">
                    ...
                    <!-- <div class="mb-3 row">
                        ...
                        <div class="col-sm">
                        <textarea name="alamat" id="alamat" class="form-control" style="width: 100%; height:70px; resize:none; "></textarea>
                        </div>
                    </div> -->
                    <div class="mb-3 row">
                        <label for="alamat" class="col-sm-4 col-form-label ms-3">Alamat</label>
