            ...
            <div class="card-body">
                ...
                <div class="row ">
                    <div class="table-responsive text-center rounded">
                        ...
                        <tr class="table-dark" Style = "background-color : blue;">
                            <th>No</th>
                            <th>Nim</th>
                            <th>Nama</th>
                            <th>Jenis Kelamin</th>
                        ...
                        <tr>
                            ...
                            <a href="ubah.php?id=<?=$row["id"]; ?>" class="btn btn-success"><i class="bi bi-pencil-square"></i></a>
